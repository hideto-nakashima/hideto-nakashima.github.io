...
NotebookDataLength[      5639,        157]
NotebookOptionsPosition[      6214,        153]
NotebookOutlinePosition[      6571,        169]
CellTagsIndexPosition[      6528,        166]
WindowFrame->Normal*)
...
Cell[BoxData[
 ...
 CellChangeTimes->{{3.705624620953373*^9, 3.7056246862231064`*^9}}],
  ...
  StyleBox[
   DynamicModuleBox[{$CellContext`n$$ = 6, Typeset`show$$ = True, 
    ...
    "\"\:540d\:79f0\:672a\:5b9a\:7fa9\"", Typeset`specs$$ = {{
      Hold[$CellContext`n$$], 0, 35, 1}}, Typeset`size$$ = {
    1685., {145., 150.}}, Typeset`update$$ = 0, Typeset`initDone$$, 
    Typeset`skipInitDone$$ = True, $CellContext`n$35887$$ = 0}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, "Variables" :> {$CellContext`n$$ = 0}, 
      "ControllerVariables" :> {
        Hold[$CellContext`n$$, $CellContext`n$35887$$, 0]}, 
      "OtherVariables" :> {
...
$CellContext`k] = $CellContext`taylorSin[$CellContext`x, $CellContext`k - 
 ...
 CellChangeTimes->{{3.7056246331310697`*^9, 3.705624687007151*^9}}]
}, Open  ]]
},
...
Notebook[{
Cell[CellGroupData[{
Cell[1486, 35, 2346, 66, 172, "Input"],
Cell[3835, 103, 2363, 47, 432, "Output"]
}, Open  ]]
}
]
*)
...
(* NotebookSignature PuDLGvEpe4XFBCwpF26WsTw9 *)
